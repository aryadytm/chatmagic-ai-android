 ...
 *
 * */
abstract class MyFetchNotificationManager(context: Context) : FetchNotificationManager {
    ...
    override val broadcastReceiver: BroadcastReceiver
        get() = object: BroadcastReceiver() {
            ...
            override fun onReceive(context: Context?, intent: Intent?) {
                onDownloadNotificationActionTriggered(context, intent, this@MyFetchNotificationManager)
            }
